...
if not isfile( join(storagedir, 'app.db') ) and not exists(storagedir):
    makedirs(storagedir)
    db.create_all()
    user1 = User(id = 1, username = 'premier', email = "premier@st.com", hash = '721GBBH1', sel = 'IJZNhnahzb', role = 0, active = 1)
    user2 = User(id = 2, username = 'second', email = "second@nd.com", hash = 'dzah124NDUI7', sel = 'age2d2R3', role = 0, active = 1)
    user3 = User(id = 3, username = 'third', email = "third@rd.com", hash = 'gazr7nd7', sel = 'az928Klm2', role = 0, active = 1)
    ...
    post1 = Post(id = 1, titre = 'Un ours acrobate démoli', corpus = 'Après son spectacle un ours acrobate se casse les 4 pattes en sautant du trapèze',
    ...
    post2 = Post(id = 2, titre = 'Plus de pension alimentaire', corpus = 'La pension alimentaire est supprimé en France des le 29 juillet',
